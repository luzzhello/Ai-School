...
CREATE TABLE IF NOT EXISTS `lit_paper` (
  ...
  `authors`        VARCHAR(1000) DEFAULT NULL COMMENT '作者/申请者/发布单位',
  `organs`         VARCHAR(1000) DEFAULT NULL COMMENT '机构',
  `abstract_text`  MEDIUMTEXT    DEFAULT NULL COMMENT '摘要',
  `keywords`       VARCHAR(500)  DEFAULT NULL COMMENT '关键词',
  `source`         VARCHAR(1000) DEFAULT NULL COMMENT '刊名/文集名/授予单位/书名来源',
  `year`           INT           DEFAULT NULL COMMENT '年份',
  `volume`         VARCHAR(64)   DEFAULT NULL COMMENT '卷号',
  `issue`          VARCHAR(64)   DEFAULT NULL COMMENT '期号',
  `pages`          VARCHAR(100)  DEFAULT NULL COMMENT '起-止页码，如 45-52',
  `publisher`      VARCHAR(200)  DEFAULT NULL COMMENT '出版者',
  `publish_place`  VARCHAR(200)  DEFAULT NULL COMMENT '出版地/授予单位所在地',
  `translator`     VARCHAR(200)  DEFAULT NULL COMMENT '译者（译著）',
  `degree`         VARCHAR(100)  DEFAULT NULL COMMENT '学位类型，如 硕士/博士',
  `degree_place`   VARCHAR(200)  DEFAULT NULL COMMENT '授予单位所在地（学位论文）',
